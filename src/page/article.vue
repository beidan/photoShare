  ...
  <div>
    <div class="com-article">
      <div class="user">
        ...
        <div class="name">
          <p>{{resData.memberNickname}}
            <span v-bind:class="{ hasZan : !(resData.memberIsFavShared-1) }" class="Userstar" @click="userstar(resData.memberId)"><span class="icon iconfont icon-jushoucang"></span> <span> 收藏</span></span>
          </p>
      ...
      <p class="operate">
        ...
        <span v-bind:class="{ hasZan : !(resData.memberIsFavShared-1) }" class="star" @click="star(resData.sharedId,resData.memberId)"><span class="icon iconfont icon-jushoucang"></span> <span> 收藏</span></span>
      </p>
      <p class="starList">
